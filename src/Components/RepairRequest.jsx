...
const RepairRequest = ({reqimg,itmname,serial,lab,datereq,description}) => {
  return (
    <div className='w-[1044px] h-20 bg-[#03ADE5] rounded-[10px] shadow-sm flex flex-row justify-evenly items-center my-2'>
      ...
      <button className='w-[90px] h-[47px] bg-[#B3C3E3] shadow rounded-[10px] text-[#202652] font-josefin-sans font-[500] ml-5 mr-2 '>ACCEPT</button>
    </div>
  )
}
